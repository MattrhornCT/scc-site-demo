...
export default function Order() {
  return (
    <main>
      <section className="page-pad" style={{ textAlign: 'center', paddingTop: 50, paddingBottom: 26, position: 'relative', overflow: 'hidden' }}>
        ...
        <h1 className="hero-title-sm" style={{ fontFamily: "'Bricolage Grotesque'", fontWeight: 800, fontSize: 46, letterSpacing: '-.02em', margin: '0 0 10px' }}>Let's build your order</h1>
